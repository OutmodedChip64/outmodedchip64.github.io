  ...
  render() {
    return (
      <div className="main">
        ...
        <p />
        <p style={{textAlign: "center"}}>This is the development (v0.20.03.14.1) of the 2D platformer game being developed by myself, Asher Molzer, and Isaiah Roman. (The game may take a few seconds to load)</p>
